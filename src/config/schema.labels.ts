...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.bootstrapRetrieval.mode": "Bootstrap Retrieval Mode",
  "agents.defaults.bootstrapRetrieval.thresholdChars": "Bootstrap Retrieval Threshold Chars",
  "agents.defaults.bootstrapRetrieval.topFiles": "Bootstrap Retrieval Top Files",
  "agents.defaults.bootstrapRetrieval.chunksPerFile": "Bootstrap Retrieval Chunks Per File",
  "agents.defaults.bootstrapRetrieval.maxChunkChars": "Bootstrap Retrieval Max Chunk Chars",
  "agents.defaults.bootstrapRetrieval.maxTotalChars": "Bootstrap Retrieval Max Total Chars",
