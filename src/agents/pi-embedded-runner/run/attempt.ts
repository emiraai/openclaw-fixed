...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    try {
      ...
      // Ollama native API: register "ollama" in the SDK API provider registry
      // (for completeSimple used by compaction) and override streamFn for the
      // agent run loop (#20652, #11828).
